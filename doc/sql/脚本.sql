...
insert  into `companyinfo`(`id`,`corpName`,`phone`,`name`,`job`,`password`,`email`,`state`,`approval`) values 
(1,'香港恒生','1347891102','马人才','总裁','123456','123@emailcom',1,0),
(2,'恒源祥','1356789110','李冠荣','总经理','123456','123@email.com',1,1),
(3,'香港金泰','1356689110','王爱玲','总经理','123456','123@email.com',1,1),
(4,'伊利乳业','1356678110','牛根生','总裁','123456','123@email.com',1,1),
(5,'百事通','1356678119','李小兰','总裁','123456','123@email.com',1,1),
(6,'可乐','1356678112','戴维斯','总裁','123456',NULL,NULL,NULL),
(7,'百事','32513242121',NULL,NULL,NULL,NULL,NULL,NULL),
(11,'腾讯','1311111111','马化腾','boss','123456','123@email.com',1,1),
(12,'联想','1311111112',NULL,NULL,'123456','123@email.com',1,1),
(13,'华为','1311111333','','boss','123456','123@email.com',1,1);
...
(1,'销售到访关联表',NULL,1,2,4,4,1),
(2,'销售中介关联表',NULL,1,3,2,2,1),
(6,'销售认筹关联',NULL,1,4,5,5,1),
(7,'销售与认筹关联表',NULL,1,4,4,5,1),
(8,'a表与b表',NULL,2,1,4,5,1);
...
insert  into `inform`(`id`,`title`,`publishDate`,`details`,`publisher`) values 
...
(7,'毕业通知','2017-08-30 15:16:46','<p>后天毕业典礼</p>\r\n','汪宝宝'),
(8,'11','2017-12-28 10:24:40','<p>名</p>\r\n','11'),
(9,'下排名','2017-12-28 10:24:58','<p>小明</p>\r\n','小明'),
(10,'小明','2017-12-28 10:25:12','<p>小名</p>\r\n','小明'),
(11,'小名','2017-12-28 10:25:29','<p>小名</p>\r\n','小名'),
(12,'123','2017-12-28 10:50:03','<p>123</p>\r\n','123'),
(13,'456','2017-12-28 14:10:06','<p>8888888888888888888888888888888888888888888888888888888888</p>\r\n','465');
...
(1,'per1',NULL,NULL,NULL),
(2,'per2',NULL,NULL,NULL),
(3,'per3',NULL,NULL,NULL),
(4,'per4',NULL,NULL,NULL);
...
insert  into `tableinfo`(`id`,`name`,`updateTime`,`physicalTableName`,`cid`,`state`,`showtype`) values 
(1,'销售数据表','2017-08-30 10:34:31',NULL,1,NULL,'0'),
(2,'到访数据表','2017-08-30 03:22:07',NULL,1,NULL,'1'),
(9,'认筹表','2017-12-28 11:15:21',NULL,1,NULL,'0'),
(10,'经费','2017-12-28 02:22:50',NULL,1,NULL,'0'),
(18,'付家东','2017-12-28 09:26:44',NULL,1,NULL,'0');
...
insert  into `userinfo`(`id`,`user_name`,`job`,`password`,`phone`,`email`,`state`) values 
(1,'Bill','Manager','123456','123',NULL,1),
(2,'Lily','Secratry','123456','234',NULL,1),
(3,'Bob','Aassistant','123456','345',NULL,1),
(4,'Jack','Customer','123456','567',NULL,1);
